...
//! ```
//!
//! ### 4.8 Optional anchors
//!
//! The regular expressions generated by *grex* are strict and always
//! stick to edges of the line by the anchors "^" and "$", meaning the
//! beginning and the end of the line, respectively. It's possible to
//! avoid printing one or both anchors.
//!
//! ### 4.8.1. Optional "^" anchor - don't stick to the left edge
//!
//! ```
//! use grex::RegExpBuilder;
//!
//! let regexp = RegExpBuilder::from(&["abc"])
//!     .with_line_borders(false, true)
//!     .build();
//! assert_eq!(regexp, "abc$");
//! ```
//!
//! ### 4.8.2. Optional "$" anchor - don't stick to the right edge
//!
//! ```
//! use grex::RegExpBuilder;
//!
...
//! ```
//!
//! ### 4.8.3. Optional "^" and "$" anchors - don't stick to both edges
//!
//! ```
//! use grex::RegExpBuilder;
//!
