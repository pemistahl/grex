...
impl RegExpConfig {
    ...
    pub(crate) fn is_digit_converted(&self) -> bool {
        self.is_digit_converted || self.conversion_features.contains(&Feature::Digit)
    }

    pub(crate) fn is_non_digit_converted(&self) -> bool {
        self.is_non_digit_converted || self.conversion_features.contains(&Feature::NonDigit)
    }

    pub(crate) fn is_space_converted(&self) -> bool {
        self.is_space_converted || self.conversion_features.contains(&Feature::Space)
    }

    pub(crate) fn is_non_space_converted(&self) -> bool {
        self.is_non_space_converted || self.conversion_features.contains(&Feature::NonSpace)
    }

    pub(crate) fn is_word_converted(&self) -> bool {
        self.is_word_converted || self.conversion_features.contains(&Feature::Word)
    }

    pub(crate) fn is_non_word_converted(&self) -> bool {
        self.is_non_word_converted || self.conversion_features.contains(&Feature::NonWord)
    }

    pub(crate) fn is_repetition_converted(&self) -> bool {
        self.is_repetition_converted || self.conversion_features.contains(&Feature::Repetition)
    }
